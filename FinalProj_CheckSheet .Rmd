---
title: 'Final Project: CheckSheet'
...
(A) .Rmd Line numbers where at least two different data sources are imported: 39~42


(B) .Rmd Line numbers for inspecting data intake:  48~61, 108~109
...
(A) .Rmd Line number(s) for general data wrangling: 64 ~ 66,70 ~ 74, 80 ~ 87,92 ~ 96, 101, 108 ~ 116, 128 ~ 131, 141 ~ 145, 159 ~ 165


(B) .Rmd Line number(s) for a join operation: 169 ~ 179


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent):100


(D) .Rmd Line number(s) for use of regular expressions: 116 ~ 117,130,148


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 58,61,82 ~ 85, 94 ~ 96, 149 ~ 150, 131 ~ 132
...
(A) .Rmd Line number(s) for use of mulitple different geoms:119 ~ 120,135 ~ 136,154 ~ 155

(B) .Rmd Line number(s) for use of multiple aesthetics:119 ~ 120, 135 ~ 136, 154 ~ 155,112

(C) .Rmd Line number(s) for use of layered graphics: 113 ~ 114
